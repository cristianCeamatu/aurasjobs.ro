    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">@lang('welcome.about_us')</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                @lang('welcome.about_us_details')
            </div>
        </div>
    </div>
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">@lang('welcome.about_heading')</h2>
                    <h3 class="section-subheading text-muted">@lang('welcome.about_subheading')</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 text-center">
                    <p class="large text-muted">@lang('welcome.about_footer')</p>
                </div>
            </div>
        </div>
    </section>
